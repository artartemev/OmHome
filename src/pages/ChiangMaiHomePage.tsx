...
export function ChiangMaiHomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#f3f0ec] text-[#201d54]">
      <motion.header
        initial={{ y: -80, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.5 }}
        className="fixed inset-x-0 top-0 z-40 border-b border-[#5b57c0]/25 bg-[#f3f0ec]/90 backdrop-blur"
      >
        <div className="container mx-auto px-4">
          <nav className="flex items-center justify-between py-4">
            <motion.a
              ...
              href="#hero"
              className="font-menorah text-2xl font-medium text-[#5b57c0]"
            >
              OmHome Chiang Mai
            </motion.a>
            ...
            <div className="hidden lg:flex items-center gap-6 text-sm">
              {navLinks.map((link, index) => (
                <motion.button
                  ...
                  className="rounded-full px-3 py-2 font-semibold text-[#201d54] transition-colors hover:bg-white hover:text-[#5b57c0]"
                >
                  {link.label}
                </motion.button>
              ))}
              <a
                href="/pamho"
                className="ml-4 inline-flex items-center gap-2 rounded-full bg-[#5b57c0] px-4 py-2 font-semibold text-white shadow-lg shadow-[#5b57c0]/20 transition hover:bg-[#4541a3]"
              >
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-lg p-2 text-[#5b57c0] transition hover:bg-[#e3e1fb] lg:hidden"
            ...
            <div className="space-y-3 pb-6">
              {navLinks.map((link) => (
                <button
                  key={link.href}
                  onClick={() => handleNavigation(link.href)}
                  className="block w-full rounded-2xl bg-white px-4 py-3 text-left text-base font-semibold text-[#201d54] shadow-sm transition hover:bg-[#f1f0ff]"
                >
                  {link.label}
                </button>
              ))}
              <a
                href="/pamho"
                className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-[#5b57c0] px-4 py-3 font-semibold text-white shadow-lg shadow-[#5b57c0]/20"
              >
      ...
      <main className="pt-24 lg:pt-32" id="hero">
        <section className="relative overflow-hidden">
          <div className="absolute inset-0 -z-10 bg-gradient-to-br from-[#f4ece2] via-[#ece8ff] to-[#dedafc]" />
            ...
            <div className="grid gap-12 lg:grid-cols-[1.15fr_1fr] lg:items-center">
              <div className="space-y-6">
                <motion.div
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-semibold text-[#5b57c0] shadow-sm"
                >
                ...
                <motion.h1
                  ...
                  className="font-menorah text-4xl leading-tight text-[#1d1a4d] sm:text-5xl lg:text-6xl"
                >
                ...
                <motion.p
                  ...
                  className="text-lg leading-relaxed text-[#2a276a] sm:text-xl"
                >
                ...
                >
                  <a
                    href="#schedule"
                    className="inline-flex items-center gap-2 rounded-full bg-[#5b57c0] px-6 py-3 text-base font-semibold text-white shadow-lg shadow-[#5b57c0]/25 transition hover:bg-[#4541a3]"
                  >
                    <CalendarCheck className="h-5 w-5" /> Смотреть афишу
                  </a>
                  <a
                    href="#map"
                    className="inline-flex items-center gap-2 rounded-full border border-[#5b57c0] px-6 py-3 text-base font-semibold text-[#5b57c0] transition hover:bg-[#5b57c0]/10"
                  >
                ...
                >
                  {heroBadges.map((badge) => (
                    <span
                      key={badge}
                      className="inline-flex items-center rounded-full bg-white px-4 py-2 text-sm font-semibold text-[#201d54] shadow-sm shadow-[#5b57c0]/10"
                    >
                      {badge}
                    </span>
                  ))}
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="absolute inset-0 -z-10 rounded-[3rem] bg-gradient-to-br from-[#f0ecff] via-[#ffeef5] to-[#fff5e6] blur-2xl opacity-80" />
                <div className="rounded-[2.5rem] border border-white/80 bg-white p-8 shadow-2xl shadow-[#5b57c0]/15">
                  <div className="space-y-4 text-[#2a276a]">
                    <h2 className="text-2xl font-semibold text-[#1d1a4d]">Добро пожаловать домой</h2>
                    <p className="text-base leading-relaxed text-[#2a276a]">
                    ...
                    <div className="grid gap-3 sm:grid-cols-3">
                      <div className="rounded-2xl bg-[#f4efff] p-4 text-sm font-semibold text-[#201d54] shadow-sm">☕ Чай и беседы</div>
                      <div className="rounded-2xl bg-[#fff1e5] p-4 text-sm font-semibold text-[#201d54] shadow-sm">🧘 Практики</div>
                      <div className="rounded-2xl bg-[#ffe7f7] p-4 text-sm font-semibold text-[#201d54] shadow-sm">🎶 Музыка</div>
                    </div>
                  </div>
                </div>
              </motion.div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
              <div className="space-y-6">
                ...
                <p className="text-lg leading-relaxed text-[#2a276a]">
                ...
                <div className="rounded-3xl border border-[#5b57c0]/20 bg-white p-6 shadow-lg shadow-[#5b57c0]/10">
                  <p className="text-lg font-semibold text-[#2c298a]">Здесь можно:</p>
                  <ul className="mt-4 space-y-3 text-base leading-relaxed text-[#2a276a]">
              ...
              <div className="space-y-6">
                <div className="rounded-[2rem] bg-gradient-to-br from-[#f4efff] via-[#fff1e5] to-[#ffe7f7] p-8 shadow-2xl shadow-[#5b57c0]/15">
                  <h3 className="text-2xl font-semibold text-[#1d1a4d]">Дом, который живёт вместе с городом</h3>
                  <p className="mt-4 text-lg leading-relaxed text-[#2a276a]">
                    Мы — про доверие, безопасность и поддержку. Открываем двери тем, кто ищет место, где можно быть собой.
                  </p>
                  <a
                    href="/pamho"
                    className="mt-6 inline-flex items-center gap-2 rounded-full border border-[#5b57c0] px-5 py-3 text-sm font-semibold text-[#5b57c0] transition hover:bg-[#5b57c0]/10"
                  >
                    Узнать о Pamho больше
                  </a>
                </div>
                <div className="rounded-[2rem] border border-dashed border-[#5b57c0]/30 bg-white p-8 shadow-lg shadow-[#5b57c0]/10">
                  <p className="text-sm uppercase tracking-[0.3em] text-[#5b57c0]">Пространство тепла</p>
                  <p className="mt-3 text-lg leading-relaxed text-[#2a276a]">
          ...
          <div className="container mx-auto px-4">
            <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <p className="mt-2 text-lg text-[#2a276a]">
                  Форматы, которые создают настроение и знакомят с новыми друзьями.
                </p>
              </div>
              <a
                href="#initiative"
                className="inline-flex items-center gap-2 rounded-full border border-[#5b57c0] px-5 py-3 text-sm font-semibold text-[#5b57c0] transition hover:bg-[#5b57c0]/10"
              >
                Предложить событие
              </a>
            </div>
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {eventHighlights.map((event) => (
                <motion.div
                  key={event.title}
                  whileHover={{ y: -6 }}
                  className="rounded-3xl border border-[#5b57c0]/20 bg-white p-6 shadow-lg shadow-[#5b57c0]/10"
                >
                  <div className="text-4xl">{event.icon}</div>
                  <h3 className="mt-4 text-xl font-semibold text-[#2c298a]">{event.title}</h3>
                  <p className="mt-2 text-base leading-relaxed text-[#2a276a]">{event.description}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section id="principles" className="py-20">
          <div className="container mx-auto px-4">
            <div className="rounded-[3rem] border border-[#5b57c0]/20 bg-gradient-to-br from-[#f4efff] via-[#fff1e5] to-[#ffe7f7] p-10 shadow-2xl shadow-[#5b57c0]/10">
              ...
              <div className="mt-8 rounded-3xl border border-[#5b57c0]/20 bg-white p-6 text-lg leading-relaxed text-[#2a276a] shadow-lg shadow-[#5b57c0]/10">
          ...
          <div className="container mx-auto px-4">
            <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              <div className="space-y-6">
                ...
                <ul className="space-y-3 text-lg leading-relaxed text-[#2a276a]">
                ...
                <a
                  href="#join"
                  className="inline-flex items-center gap-2 rounded-full bg-[#5b57c0] px-6 py-3 text-base font-semibold text-white shadow-lg shadow-[#5b57c0]/20 transition hover:bg-[#4541a3]"
                >
                  ✍️ Предложить мероприятие
                </a>
              </div>
              <div className="space-y-6">
                <div className="rounded-[2rem] border border-[#5b57c0]/20 bg-white p-8 shadow-2xl shadow-[#5b57c0]/10">
                  <h3 className="text-2xl font-semibold text-[#2c298a]">Готовы поддержать идею</h3>
                  <p className="mt-3 text-base leading-relaxed text-[#2a276a]">
                ...
                <div className="rounded-[2rem] border border-dashed border-[#5b57c0]/30 bg-gradient-to-br from-[#f4efff] via-[#fff1e5] to-[#ffe7f7] p-8 text-[#1d1a4d] shadow-lg shadow-[#5b57c0]/10">
          ...
          <div className="container mx-auto px-4">
            <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
              <div className="space-y-6">
                ...
                <div className="rounded-[2rem] border border-dashed border-[#5b57c0]/30 bg-white p-6 text-base leading-relaxed text-[#2a276a] shadow-lg shadow-[#5b57c0]/10">
                  Фото дома скоро появится — мы уже готовим визуальные истории о пространстве.
                </div>
              </div>
              <div className="space-y-5">
                <div className="overflow-hidden rounded-[2.5rem] border border-[#5b57c0]/20 shadow-xl shadow-[#5b57c0]/15">
                  <iframe
        ...
        <section id="schedule" className="py-20">
          <div className="container mx-auto px-4">
            <div className="rounded-[3rem] border border-[#5b57c0]/20 bg-white p-10 shadow-2xl shadow-[#5b57c0]/10">
              <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                <div>
                  <h2 className="font-menorah text-3xl text-[#2c298a] sm:text-4xl">📅 Афиша</h2>
                  <p className="mt-3 max-w-2xl text-lg leading-relaxed text-[#2a276a]">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-full bg-[#5b57c0] px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-[#5b57c0]/20 transition hover:bg-[#4541a3]"
                >
              ...
              <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                {[1, 2, 3].map((item) => (
                  <div
                    key={item}
                    className="rounded-3xl border border-dashed border-[#5b57c0]/30 bg-gradient-to-br from-[#f4efff] via-[#fff1e5] to-[#ffe7f7] p-6 text-center text-base font-semibold text-[#1d1a4d] shadow-lg shadow-[#5b57c0]/10"
                  >
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {testimonials.map((testimonial) => (
                <div
                  key={testimonial}
                  className="rounded-[2rem] border border-[#5b57c0]/20 bg-white p-6 text-base leading-relaxed text-[#2a276a] shadow-lg shadow-[#5b57c0]/10"
                >
                  {testimonial}
                </div>
              ))}
      ...
      <footer className="border-t border-[#5b57c0]/15 bg-white py-8 text-center text-sm text-[#2a276a]/80">
